...
@section('content')
    ...
    <div class="col-md-10 mx-auto">
        <form action="{{ url('document')}}" class="form-control dropzone" id="dropzone">
            <div class="fallback">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <div class="">
                                    <a href="{{ url('download')}}/{{$document->id}}" class="btn btn-sm shadow-none bg-info-light btn-info px-3 mb-0 "><i class="fas text-info-light  fa-download text-sm me-1"></i>
                                    </a>
                                    <a class="btn btn-sm bg-pink-light shadow-none px-3 mb-0"
                                       href="{{ url('delete')}}/document/{{$document->id}}"><i class="far fa-trash-alt me-1 text-danger text-sm"></i>
                                    </a>
                                </div>
