...
class FrontendController extends WebsiteBaseController
{
    ...
    public function verifycertificate(Request $request)
    {
        ...
        {
            return view("frontend.verifyform")->with(array('data' => "Your Verication Number Is Wrong",'number' => $request->id));
        }else{
            $users = User::all()
            ->keyBy("id")
            ->all();
    ...
    public function regularcake()
    {
        return view("frontend.regularcake");
    }
    public function premiumcake()
    {
        return view("frontend.premiumcake");
    }
